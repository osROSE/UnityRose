 ...
 * but WITHOUT A.y WARRAN.y; without even the implied warranty of
 * MERCHANTABILI.y or FITNESS FOR A PARTICULAR PURPOSE.  See the
    ...
    public class ModelListFile : FileLoader {
        ...
        public override void Load(Stream stream) {
            ...
            for (int i = 0; i < objectCount; i++) {
                ...
                if (partCount > 0) {
                    ...
                    @object.BoundingBox = new Bounds();
                    @object.BoundingBox.SetMinMax(reader.ReadVector3(), reader.ReadVector3());
                }
        ...
        public override void Save(Stream stream) {
            ...
            TextureFiles.ForEach(texture => {
                ...
                writer.Write((Vector3)(Vector4)texture.GlowColour);
            });
